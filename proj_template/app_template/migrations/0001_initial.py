    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('historical_games', models.ManyToManyField(blank=True, related_name='teams', to='app_template.historicaldata')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teamPicked', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_template.nflteam')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
